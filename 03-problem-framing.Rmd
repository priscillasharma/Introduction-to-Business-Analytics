...
What goes into a business problem statement exactly? It is essentially a more or less informal contract for work. The more specific it is the less potential there is for scope creep later on. 
[Scope creep](https://en.wikipedia.org/wiki/Scope_creep): Changes to, or uncontrolled growth in, a project's scope after the project begins, which can occur when a project is not initially well-defined.
